...
const vi: Dict = {
  ...
  'welcome.gameHubIntro': 'Bored? Try the Game Hub 🎮',
  'welcome.gameHubBody': '5 mini-games: snake, tic-tac-toe, memory, 2048, sudoku. Click any to play.',
  'welcome.openHub': 'Open Game Hub',

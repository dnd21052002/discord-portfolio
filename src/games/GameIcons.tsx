...
export function SudokuIcon({ size = 24 }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="3" width="6" height="6" rx="0.5" fill="currentColor" opacity="0.25" />
      <rect x="9" y="3" width="6" height="6" rx="0.5" />
      <rect x="15" y="3" width="6" height="6" rx="0.5" fill="currentColor" opacity="0.5" />
      <rect x="3" y="9" width="6" height="6" rx="0.5" fill="currentColor" opacity="0.5" />
      <rect x="9" y="9" width="6" height="6" rx="0.5" fill="currentColor" opacity="0.25" />
      <rect x="15" y="9" width="6" height="6" rx="0.5" />
      <rect x="3" y="15" width="6" height="6" rx="0.5" />
      <rect x="9" y="15" width="6" height="6" rx="0.5" fill="currentColor" opacity="0.5" />
      <rect x="15" y="15" width="6" height="6" rx="0.5" fill="currentColor" opacity="0.25" />
    </svg>
  )
}
